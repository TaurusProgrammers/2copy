(function (w, d) {
	...
	var index = 0;
	var interval = null;
	var messages = ['2copy agiliza tu trabajo', 'Garantiza seguridad y puntualidad','Ademas que presenta una excelente plataforma','Para la comodida de sus clientes']; // Cada posicion del array es un mensaje
